...
for j in range(0, 1):
    ...
    for i in range(6):
        fileResultsDetailsData = pd.read_csv("New Test Results\\GWOM Shrunk + Restarts\\30x75x4000 " + str(-i) +"\\experiment_details.csv")
    ...
    fig_name = "New Test Results\\Function Shift Comparisons\\" + "/GWOM Shrunk + Restarts" + ".png"
