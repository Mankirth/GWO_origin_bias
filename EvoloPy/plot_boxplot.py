...
for j in range(0, 1):
    ...
    for i in range(6):
        fileResultsDetailsData = pd.read_csv("Test Results\\GWOM Updated Shrunken RBTs\\30x75x4000 " + str(-i) +"\\experiment_details.csv")
    ...
    plt.title("GWO Modified W/ Shrunken Search Space Function Shift Comparison")
    plt.ylabel("Fitness")
    plt.legend(
        handles=box["boxes"],
    ...
    fig_name = "Test Results\\Rastrigin Function Shift Comparison\\" + "/boxplot-" + "GWOM_Updated_function_shifts" + ".png"
