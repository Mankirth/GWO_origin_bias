...
def EPSO(objf, lb, ub, dim, PopSize, iters, seed):
    np.random.seed(seed)
    """
    ...
    for l in range(iters):
        ...
        if (l + 1) in restart_points:
            ...
            collected = top50.pop(0) if top50 else np.empty((0, dim))
