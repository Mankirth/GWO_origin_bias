...
for j in range(0, 6):
    ...
    fileResultsDetailsData = pd.read_csv("Tests 30x50x6000 V2\\GWO\\Origin Shift\\GWO " + str(-j) + "\\experiment_details.csv")
    ...
    fileResultsDetailsData = pd.read_csv("Tests 30x50x6000 V2\\GWOM\\Origin Shift\\GWOM " + str(-j) + "\\experiment_details.csv")
    objective_name = "rastrigin"
    ...
    fig_name = "Tests 30x50x6000 V2\\" + "/" + str(-j) + " origin_shift_function_comparison" + ".png"
