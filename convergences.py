...
data = np.zeros((30, 2000))
fileResultsDetailsData = pd.read_csv("Tests 30x50x6000 V2\\GWO\\Both Shift\\GWO -1\\experiment_details.csv")
...
for t in range(0,30):
    ...
    plt.grid()
    fig_name = "Convergences/TestConvergence"+ str(t) + "-" + objective_name + ".png"
